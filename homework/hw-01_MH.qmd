...
Every homework assignment and lab in this class will be written in Quarto, with a template provided for you to use for the first few assignments. This homework's template can be downloaded by typing in the following code in the Console:

```{r}
download.file("https://mhoch422.github.io/BIOS600_SSII/homework/hw-01-template.qmd", destfile="hw-01.qmd")
```
