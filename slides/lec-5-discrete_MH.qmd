...
Thus $Z \sim Pois(1.5)$, since we define the Poisson distribution by the rate (1.5 deaths per year).

. . .

Further, $P(Z=0)$, $P(Z=1)$, and $P(Z\geq 2)$ are disjoint events. 

. . .

So, $P(Z \geq 2) = 1- [P(Z = 0) + P(Z = 1)]$, where
