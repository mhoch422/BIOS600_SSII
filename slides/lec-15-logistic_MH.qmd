...
- You should have access to the evaluation for this class through Canvas, or through an email from the course evaluation team.


- This feedback is helpful, both to the Biostatistics Department as it evaluates whether to keep offering this as a summer course, and to me, so that I can learn what parts of class worked well and improve as an instructor going forward.
...
## From probabilities to log odds {.smaller}
...
Individuals smoking 20-29 cigarettes per day have exp$(\hat \beta_{cigs20-29})$=exp(0.86) times the odds of having bladder cancer compared to individuals smoking 0 cigarettes per day, **when the other predictor (NAT2) is 0**

## Interaction terms 

![](images/lect-21/genebye.jpg){fig.alt="A graph with x-axis labeled Cigarettes per day and y-axis labeled Odds Ratio. The legend says that dark blue indicates NAT2 slow and light blue indicates NAT2 rapid or intermediate. At x=0, the odds ratio for both colors is 0. At x = 0 - 9, the light blue has an odds ratio estimate of 0.6 with confidence interval 0.3 to 1.2 and the dark blue has an odds ratio estimate of 1.1 with confidence interval 0.6 to 2.1. At x = 10 - 19, the light blue has an odds ratio estimate of 1.3 with confidence interval 0.7 to 2.5 and the dark blue has an odds ratio estimate of 2 with confidence interval 1.1 to 3.5. At x = 20 - 29, the light blue has an odds ratio estimate of 1.7 with confidence interval 0.9 to 3 and the dark blue has an odds ratio estimate of 2.6 with confidence interval 1.5 to 4.6. At x = 30 - 39, the light blue has an odds ratio estimate of 1.4 with confidence interval 0.7 to 3 and the dark blue has an odds ratio estimate of 3 with confidence interval 1.5 to 5.8. At x greater than or equal to 40, the light blue has an odds ratio estimate of 1 with confidence interval 0.5 to 2 and the dark blue has an odds ratio estimate of 2 with confidence interval 1.1 to 4."}
