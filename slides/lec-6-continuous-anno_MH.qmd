...
#| echo: FALSE
#| message: FALSE
#| fig-alt: "A graph containing three bell curves, all centered on 0. The red curve, labelled Variance 0.5, is tall and skinny; the green curve, labelled Variance 1, is shorter than the red curve and wider; and the blue curve, labelled Variance 3, is shorter than both other curves and much wider."
...
```{r}
#| echo: FALSE
#| fig-alt: "A graph containing three bell curves, all with the same height and width. The red curve, labelled Mean negative 3, is centered on negative 3; the green curve, labelled Mean 0, is centered on 0; and the blue curve, labelled Mean 3, is centered on 3."
...
```{r}
#| echo: FALSE
#| fig-alt: "A graph with one bell curve. The x axis is labelled Height (inches), and the curve is centered on 65, and reaches approximately zero at 55 and 75."
...
```{r}
#| echo: FALSE
#| fig-alt: "A graph with one bell curve. The x axis is labelled Systolic Blood Pressure millimeters mercury, and the curve is centered on 125, and reaches approximately zero at 81 and 169."
...
$$z = \frac{x - \mu}{\sigma} = \frac{698 - 809}{140} = \frac{-111}{140} \approx -0.79$$
