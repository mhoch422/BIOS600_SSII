...
What are $z^*_{1-\alpha/2}$ and $z^*_{1-\beta}$? These are the $1-\alpha/2$ and $1-\beta$ quantile cutoffs of a Z-distribution.
...
## Datasaurus (Baker's Dozen) {.smaller}
...
## A Note on Karl Pearson {.smaller}
