...
- Reminder to come to office hours tomorrow 1-3 or make an appointment to go over the test for 25% of lost points back

- Hand in application exercise 2 if you haven't already!
...
- For a random sample of $n = 30$ Gillings students, the sample average IQ score is 120
...
- Remember here I **know** $\sigma$, I can derive 95% confidence interval for the Gillings students' average IQ
...
- I am 95% confident the true mean IQ for Gillings students falls between 114.6 and 125.4

## Let's say I don't know sigma

- Let's say for a random sample of $n = 30$ Gillings students, the sample average IQ score is 120 with **sample** standard deviation of 15. I can still derive 95% confidence interval for the Gillings student's average IQ using the t-distribution:
...
- I have 95% confidence that the true mean IQ for Gillings students is between 114.4 and 125.6

$$(120 - 2.045 *\frac{15}{\sqrt 30}, 120 + 2.045 * \frac{15}{\sqrt 30}) = (114.4, 125.6)$$

## Remember IQ example?

- Let's go back to knowing $\sigma$, what if I want to test whether Gillings students have higher IQs than average?
...
- Here a sample of 30 students with IQs on average of 120 points. Can we test if the average IQ score for Gillings students is the same as that in the larger population?
...
- Do Gillings students have higher IQs than average?

  - $H_0$ =
  - $H_A$ =

- Are Gillings students' IQs different than the average?
