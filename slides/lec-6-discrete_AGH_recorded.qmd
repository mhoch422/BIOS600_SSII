...
- 24 hour grace period for these due dates
- Lowest lab and lowest HW grade will be dropped 
...
right_skewed_outlier <- right_skewed_data[right_skewed_data<6]

hist(
  right_skewed_outlier,
  breaks = 30,
  col = "darkgoldenrod3",
  main = "Histogram",
  xlab = "Value"
...
- Longer tail at the higher numbers (right)
- Median is towards the lower numbers (left) within the box

```{r}
boxplot(right_skewed_outlier , col = "darkgoldenrod3", main = "Boxplot", ylab = "Value" )
```
