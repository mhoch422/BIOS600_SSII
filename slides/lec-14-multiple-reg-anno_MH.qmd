...
- HW 14 due **tomorrow** by 11:59 PM.
...
cdc <- read.csv("https://mhoch422.github.io/BIOS600_SSII/homework/data/cdc_cleaned.csv")
...
- The common way to check for multicollinearity is through Variance Inflation Factor (VIF) values. VIF values indicate the extent of multicollinearity.
