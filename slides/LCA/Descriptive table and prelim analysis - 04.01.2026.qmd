...
```{r}
combine_yrs <- read.table("Original Data/lca_combined_years.dat", 
...
#| warning: false
#| message: false
vars <- c("white", "black", "american_native", "asian_or_pi", "hispanicrace", "other_race",
          "age","obstetrics", "patient_care_hours", "prenatal", "group_fam", "group_int", 
          "group_obgyn","group_ped", "group_ger", "ruca_urban", "ruca_lrural", "ruca_srural", "hpsa_not", "hpsa_full",
...
lca_pcp_2009v2      <- read.table("Original Data/lca_pcp_2009v2.dat", 
                                  header = TRUE, sep = ",", skip = 2) 
#Changing all values of -9999 to missing
lca_pcp_2009v2[lca_pcp_2009v2==-9999] <- NA

#Reading in the datasets for 2009 and 2019 as of 1.24.23
lca_pcp_2009_12423  <- read.table("Original Data/lca_pcp_2009_1.24.23.dat", 
                                  header = TRUE, sep = ",", skip = 2) 
#Changing all values of -9999 to missing
...
```{r}
lca_pcp2019_12423   <- read.table("Original Data/lca_pcp2019_1.24.23.dat", 
                                  header = TRUE, sep = ",", skip = 2) 
#Changing all values of -9999 to missing
...
#| warning: false
#| message: false
# 2009 only (not present in 2019)
only_2009 <- lca_pcp_2009_12423[
  !lca_pcp_2009_12423$indexno %in% lca_pcp2019_12423$indexno,
]


# In both 2009 and 2019 – using 2009 data
both_2009_2019_2009 <- lca_pcp_2009_12423[
  lca_pcp_2009_12423$indexno %in% lca_pcp2019_12423$indexno,
]


#Getting means 
means_only_2009 <- sapply(
  only_2009[sapply(only_2009, is.numeric)],
  mean,
  na.rm = TRUE
)

means_both_2009 <- sapply(
  both_2009_2019_2009[sapply(both_2009_2019_2009, is.numeric)],
  mean,
  na.rm = TRUE
)


comparison_2009 <- data.frame(
  Variable = names(means_only_2009),
  Mean_2009_only = means_only_2009,
  Mean_Both_2009_2019 = means_both_2009
)
comparison_2009[, -1] <- round(comparison_2009[, -1], 3)

attr(comparison_2009, "N_2009_only") <- nrow(only_2009)
attr(comparison_2009, "N_Both") <- nrow(both_2009_2019_2009)


write.xlsx(
  comparison_2009,
  file = "comparison_2009_only_vs_both.xlsx",
  rowNames = FALSE
)
...
## ---- Create groups from 2019 ----

# 2019 only (not in 2009)
only_2019 <- lca_pcp2019_12423[
  !lca_pcp2019_12423$indexno %in% lca_pcp_2009_12423$indexno,
]

# In both 2009 and 2019 (keeping 2019 values)
both_2009_2019_2019 <- lca_pcp2019_12423[
  lca_pcp2019_12423$indexno %in% lca_pcp_2009_12423$indexno,
]

## ---- Compute means (numeric variables only) ----

means_only_2019 <- sapply(
  only_2019[sapply(only_2019, is.numeric)],
  mean,
  na.rm = TRUE
)

means_both_2019 <- sapply(
  both_2009_2019_2019[sapply(both_2009_2019_2019, is.numeric)],
  mean,
  na.rm = TRUE
)
...
comparison_2019 <- data.frame(
  Variable = names(means_only_2019),
  Mean_2019_only = means_only_2019,
  Mean_Both_2009_2019 = means_both_2019
)

## Round for readability
comparison_2019[, -1] <- round(comparison_2019[, -1], 3)
...
write.xlsx(
  comparison_2019,
  file = "comparison_2019_only_vs_both.xlsx",
  rowNames = FALSE
)
```
