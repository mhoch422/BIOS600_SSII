---
title: "Lecture 9: Comparing Two Means"
...
- Come to my office hours **today** from 1-3 or make an appointment to go over your exam!

- Fill out yesterday's participation survey by the end of today.

## Announcements

- Lab 2 tutorial posted and assignment is available on Canvas.

- For this week's lab, I will also be going through the tutorial during the lab session on Friday; the video tutorial is available as a reference when working on the assignment. 
...
- If you lower $\alpha$ for example from 0.05 to 0.01
  - Lowers chance of **Type I** error (rejecting $H_0$ when it is actually true) but since it's now harder in general to reject $H_0$ you are increasing the chance of a **Type II** error (not rejecting $H_0$ when it is false)

- If you increase $\alpha$ for example from 0.10 to 0.15
  - Increases change of **Type I** error (rejecting $H_0$ when it is actually true) but since it's now easier in general to reject $H_0$ you are decreasing the chance of a **Type II** error (not rejecting $H_0$ when it is false)
...
- `pacu30min_swallowPain`: Swallow pain score 30 minutes after surgery (11-point scale:
...
-   A school athletics department wants to test the effectiveness of the new type of training proposed by comparing the average times of 30 runners in the 100 meters in seconds before and after the new training is implemented.
...
- For this example, you will work with a partner (try for someone you haven't worked with before!) on Application Exercise 3.

- Start by working on Question 1.
...
Continue with today's application exercise by completing Question 2.
